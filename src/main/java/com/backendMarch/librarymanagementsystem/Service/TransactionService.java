...
public class TransactionService {
    ...
    public IssueBookResponseDto issueBook(IssueBookRequestDto issueBookRequestDto) throws Exception {
        ...
        message.setFrom("backendcvv@gmail.com");
        message.setTo(card.getStudent().getEmail());
        message.setSubject("Issue Book Notifications");
    ...
    public String getAllTxns(int cardId){
        List<Transaction> transactionList = transactionRepository.getAllSuccessfulTxnsWithCardNo(cardId);
        String ans = "";
